...
const translations = {
    pt: {
        ...
        desc_comprecripto: "Compre Cripto facilita a compra de criptomoedas de forma simples e segura.",
        ...
        desc_orbitx: "Cartão VISA Signature premium self-custodial. Você possui as chaves. Stablecoins gastáveis!",
        ...
        desc_nexo: "Banco digital focado em crypto com cartão, rendimentos e empréstimos garantidos por cripto.",
        ...
        desc_hyperliquid: "DEX de alta performance com order book on-chain e derivativos perpétuos. Trading rápido e sem custódia em sua própria blockchain L1.",
        ...
        desc_uruguayhub: "Assessoria completa para internacionalização, residência legal e fiscal no Uruguai, abertura de contas internacionais e proteção patrimonial.",
        ...
        desc_mqmpix: "PIX P2P instantâneo e seguro. Compre e venda cripto com brasileiros. Sem intermediários, com segurança.",
    ...
    en: {
        ...
        desc_comprecripto: "Compre Cripto facilitates the purchase of cryptocurrencies simply and safely.",
        ...
        desc_bitso: "Crypto card to spend cryptocurrencies anywhere in Latin America.",
        desc_cypher: "Crypto card for daily use. Recharge with +500 tokens from EVM, Cosmos, Solana and Tron.",
        desc_orbitx: "Premium self-custodial VISA Signature card. You own the keys. Spendable stablecoins!",
        ...
        desc_nexo: "Crypto-focused digital bank with card, yields and crypto-guaranteed loans.",
        ...
        desc_hyperliquid: "High-performance DEX with an on-chain order book and perpetual derivatives. Fast, non-custodial trading on its own L1 blockchain.",
        ...
        desc_uruguayhub: "Complete advisory for internationalization, legal and tax residency in Uruguay, opening international accounts and asset protection.",
        desc_dexscreener: "Real-time charts and analysis of tokens in DEXs.",
        desc_hodle: "Negocie criptomoedas P2P de forma rápida e segura.",
        desc_satsterminal: "Swaps, empréstimos e yield de Bitcoin. Agregação de liquidez no ecossistema Bitcoin.",
        desc_mqmpix: "Instant and secure PIX P2P. Buy and sell crypto with Brazilians. No intermediaries, with security.",
    ...
    es: {
        ...
        heroSubtitle: "El primer agregador On-Ramp e Off-Ramp del mercado",
        ...
        desc_comprecripto: "Compre Cripto facilita la compra de criptomonedas de forma sencilla y segura.",
        ...
        desc_bitso: "Tarjeta cripto para gastar criptomoneda en cualquier lugar de América Latina.",
        desc_cypher: "Tarjeta cripto para uso diario. Recarga con +500 tokens de EVM, Cosmos, Solana y Tron.",
        desc_orbitx: "Tarjeta VISA Signature premium autocustodiada. Usted es dueño de las llaves. ¡Stablecoins gastables!",
        ...
        desc_nexo: "Banco digital centrado en cripto con tarjeta, rendimientos y préstamos respaldados por cripto.",
        ...
        desc_hyperliquid: "DEX de alto rendimiento con libro de órdenes on-chain y derivados perpetuos. Trading rápido y sin custodia en su propia blockchain L1.",
        ...
        desc_uruguayhub: "Asesoría completa para internacionalización, residencia legal y fiscal en Uruguay, apertura de cuentas internacionales y protección patrimonial.",
        desc_dexscreener: "Gráficos en tiempo real e análise de tokens em DEXs.",
        desc_hodle: "Negocie criptomoedas P2P de forma rápida e segura.",
        desc_satsterminal: "Swaps, empréstimos e yield de Bitcoin. Agregação de liquidez no ecossistema Bitcoin.",
        desc_mqmpix: "PIX P2P instantáneo y seguro. Compra y venda cripto con brasileños. Sin intermediarios, con seguridad.",
